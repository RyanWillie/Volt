...
def define_power_input_and_regulator(design: volt.Design) -> volt.ModuleDefinition:
    ...
    j1 = module.instantiate(connector, ref="J")
    u5 = module.instantiate(regulator, ref="U5")
    u3v3 = module.instantiate(regulator, ref="U3V3")
    c_in = module.instantiate(passive, ref="CIN")
    c_5v = module.instantiate(passive, ref="C5V")
    c_3v3 = module.instantiate(passive, ref="C3V3")
    c_vdda = module.instantiate(passive, ref="CVDDA")

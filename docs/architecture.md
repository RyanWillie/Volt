...
electrical, net-class, parts, BOM sourcing, schematic, and assembly CPL option
...
subsystems (PCB outside the assembly CPL option boundary, IO, adapters, authoring) still

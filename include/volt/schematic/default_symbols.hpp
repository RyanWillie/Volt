...
inline void add_two_pin_anchors(SymbolDefinition &symbol, std::string left_name,
                                std::string left_number, std::string right_name,
...
[[nodiscard]] inline SymbolDefinition led_symbol(std::string_view name) {
...
[[nodiscard]] inline SymbolDefinition test_point_symbol(std::string_view name) {
    auto symbol = SymbolDefinition{std::string{name}};
...
[[nodiscard]] inline SymbolDefinition
connector_symbol(std::string_view name, std::initializer_list<std::string_view> pin_names) {
    auto symbol = SymbolDefinition{std::string{name}};
...
[[nodiscard]] inline SymbolDefinition regulator_symbol(std::string_view name) {
    auto symbol = SymbolDefinition{std::string{name}};
...
[[nodiscard]] inline SymbolDefinition op_amp_symbol(std::string_view name) {
    auto symbol = SymbolDefinition{std::string{name}};
...
[[nodiscard]] inline std::optional<SymbolDefinition>
default_schematic_symbol(std::string_view name) {

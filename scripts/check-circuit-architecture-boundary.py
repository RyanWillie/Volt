...
def run_self_tests() -> int:
    ...
    submodel_derivation_sample = textwrap.dedent(
        """
        struct TestSchematicSheetModel : volt::SchematicSheetModel {
          public:
            using SchematicSheetModel::add_sheet;
        };
        """
    )
    ...
    require_self_test(
        any(
            derivation.derived == "TestSchematicSheetModel"
            and derivation.base == "SchematicSheetModel"

...
[[nodiscard]] inline std::string sexpr_string(std::string_view value) {
...
inline void write_xy(std::ostream &out, Point point) {
    out << "(xy ";
...
inline void write_at(std::ostream &out, Point point, SchematicOrientation orientation) {
    out << "(at ";
    write_number(out, point.x());
    out << ' ';
    write_number(out, point.y());
...
[[nodiscard]] inline std::string stable_uuid(std::size_t value) {
...
[[nodiscard]] inline std::string symbol_library_name(const SymbolDefinition &symbol) {
    return "Volt:" + symbol.name();
}

[[nodiscard]] inline std::string property_value_to_string(const PropertyValue &value) {
    switch (value.kind()) {
...
inline void write_effects(std::ostream &out, bool hidden = false) {
...
[[nodiscard]] inline std::string component_value(const ComponentInstance &component,
...
inline void write_symbol_property(std::ostream &out, std::string_view name, std::string_view value,
...
inline void write_library_property(std::ostream &out, std::string_view name, std::string_view value,
                                   Point at) {
    out << "      (property " << sexpr_string(name) << ' ' << sexpr_string(value) << " ";
    write_at(out, at, SchematicOrientation::Right);
    out << "\n";
...
inline void report_unsupported_primitives(const SymbolDefinition &symbol, LossReport &loss_report) {
...
inline void write_symbol_pin(std::ostream &out, const SymbolPin &pin) {
...
inline void write_library_symbol(std::ostream &out, const SymbolDefinition &symbol) {
...
inline void write_wire(std::ostream &out, const WireRun &wire, std::size_t index) {
    out << "  (wire\n";
    out << "    (pts";
...
inline void write_symbol_instance(std::ostream &out, const Schematic &schematic,
                                  SymbolInstanceId id, std::size_t index) {
...
[[nodiscard]] inline SchematicExportResult write_flat_schematic(const Schematic &schematic) {

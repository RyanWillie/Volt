...
[[nodiscard]] inline std::string_view schematic_orientation_name(SchematicOrientation orientation) {
    switch (orientation) {
...
[[nodiscard]] inline std::optional<SchematicOrientation>
...
[[nodiscard]] inline std::string_view symbol_line_role_name(SymbolLineRole role) {
    switch (role) {
...
[[nodiscard]] inline std::optional<SymbolLineRole>
...
text_horizontal_alignment_name(TextHorizontalAlignment alignment) {
    switch (alignment) {
...
[[nodiscard]] inline std::optional<TextHorizontalAlignment>
...
[[nodiscard]] inline std::string_view
text_vertical_alignment_name(TextVerticalAlignment alignment) {
    switch (alignment) {
...
[[nodiscard]] inline std::optional<TextVerticalAlignment>
...
[[nodiscard]] inline std::string_view sheet_orientation_name(SheetOrientation orientation) {
    switch (orientation) {
...
[[nodiscard]] inline std::optional<SheetOrientation>
...
[[nodiscard]] inline std::string_view route_intent_name(RouteIntent intent) {
    switch (intent) {
...
[[nodiscard]] inline std::optional<RouteIntent>
route_intent_from_name(std::string_view value) noexcept {
    if (value == "Direct") {
...
[[nodiscard]] inline std::string_view power_port_kind_name(PowerPortKind kind) {
    switch (kind) {
...
[[nodiscard]] inline std::optional<PowerPortKind>
...
[[nodiscard]] inline std::string_view sheet_port_kind_name(SheetPortKind kind) {
    switch (kind) {
...
[[nodiscard]] inline std::optional<SheetPortKind>
